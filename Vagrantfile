...
wget -nv -O /tmp/ideaIC-2017.1.1-no-jdk.tar.gz https://download.jetbrains.com/idea/ideaIC-2017.1.1-no-jdk.tar.gz
sudo tar -zxf /tmp/ideaIC-2017.1.1-no-jdk.tar.gz -C /opt
...
Vagrant.configure("2") do |config|
  ...
  config.vm.provision "shell", inline: $jdkscript
